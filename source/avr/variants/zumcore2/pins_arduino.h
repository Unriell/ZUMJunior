...
#define NUM_DIGITAL_PINS  (24) // ZUM Junior and ZUM Core 2 have 24 instead of 20 GPIOs.
#define NUM_ANALOG_INPUTS   (8) // ZUM Junior and ZUM Core 2 have 8 instead of 6 analog inputs.
